        ...
        editTextRegisterDoB.setOnClickListener(new View.OnClickListener() {
          ...
          buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String textGender; // Can not obtain the value before verifying if any button was selected or not
                               ...
                               ReadWriteUserDetails writeUserDetails = new ReadWriteUserDetails(textFullName,textDoB,textGender,textMobile);
                                ...
                                referenceProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        // hide progress bar whether user is creation is successful or not.
